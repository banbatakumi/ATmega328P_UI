...
uint8_t move_speed = 80, line_move_speed = 80;
...
void display_mode_ball() {
      ...
      if (set_mode == 0) {
            ...
            oled.fillCircle(96 + ((100 - ball_distance) / 2 + 3) * cos((ball_angle - 90) * PI / 180.000), 32 + ((100 - ball_distance) / 2 + 3) * sin((ball_angle - 90) * PI / 180.000), 2, WHITE);
